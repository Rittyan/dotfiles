...
plugins=(ruby git rails gem ssh-agent zsh-syntax-highlighting)
...
[[ -s "/Users/ritmo_sato/.gvm/bin/gvm-init.sh" ]] && source "/Users/ritmo_sato/.gvm/bin/gvm-init.sh"

# OPAM configuration
. /Users/ritmo_sato/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true

export NVM_DIR="/Users/ritmo_sato/.nvm"
